Enter openai API key and then run the script. It will provide a list of daemons installed on the system and a corresponding description of the daemon generated by AI.
